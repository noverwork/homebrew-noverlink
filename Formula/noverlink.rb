class Noverlink < Formula
  ...
  on_linux do
    on_arm do
      ...
      sha256 "59585d8dd4ac1908f8494b546dd6208e930586061d16375ac882e5e8e48af932"
    end

    on_intel do
      url "https://github.com/noverwork/noverlink/releases/download/latest/noverlink-linux-x64.tar.gz"
      sha256 "5f8f245a57f5202d85a662bf573a91cc3cf2d1809d9629e38c667e7f746b0fa4"
    end
  end
