class Noverlink < Formula
  ...
  on_linux do
    on_arm do
      ...
      sha256 "ad9387d80b20440db00edfec3e11b57fb9ea8e571af787c496f0c7bd5f7001ab"
    end

    on_intel do
      url "https://github.com/noverwork/noverlink/releases/download/latest/noverlink-linux-x64.tar.gz"
      sha256 "6255492236f204c1db36db749204204225b0826a67e5036065d4aeb28e213c24"
    end
  end
